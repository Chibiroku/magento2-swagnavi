...
return [
    'modules' => [
        ...
        'ActiveCampaign_Core' => 1,
        'ActiveCampaign_AbandonedCart' => 1,
        'ActiveCampaign_Customer' => 1,
        'ActiveCampaign_Newsletter' => 1,
        'ActiveCampaign_Order' => 1,
        'ActiveCampaign_SyncLog' => 1,
        'Bss_ImportExportCore' => 1,
        'Bss_ProductAttributesImportExport' => 1,
        'DevBera_CmsLinkToMenu' => 1,
        'MagePal_Core' => 1,
        ...
        'SwagNavi_EmailThumbnail' => 1,
        'SwagNavi_FileOptionGuard' => 1,
        'SwagNavi_ReCaptchaFrontendUi' => 1
    ]
];
